...
const Chatbox = () => {
    ...
    return (
        <div className='h-[70vh] md:h-[84vh] w-full bg-white dark:bg-neutral-900 border border-neutral-100 dark:border-neutral-800 shadow-xl md:shadow-2xl rounded-2xl md:rounded-lg p-2 md:p-3 flex flex-col'>
